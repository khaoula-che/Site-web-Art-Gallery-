...
<header>
            <div class="menu">
                ...
                <nav class="navbar navbar-expand-lg">
                    <ul>
                       ...
                       <li>
                            <a href="a-propos-.html" title="">A propos</a>
                       </li>
                       <li>
        ...
        </div></header>      <div class="top-body">
        <div id="form-conex">
            <h3 style="padding-top:50px; padding-left:50px;">Connexion administrateur</h3>
            <?php 
            ...
            ?>
            <form id="login" class="input-group-cli" method="POST" action="vérification-connexion-administrateur.php">
        ...
        <img style="margin-top: 40px; padding-left: 90px;" src="images/artist_set_3.png" height="500px">
    </div>
