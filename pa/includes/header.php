	...
	<?php } ?>
			<nav class="navbar navbar-expand-lg">
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
					<img src="images/burger-menu.png" height="30px" width="30px">
				</button>
			...
			<div class="col-xl-3 text-end col-md-1 col-3" style="margin-right:10px;">
				<div class="dropdown">
					<a href="#" class="d-block link-dark text-decoration-none dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
					<img src="images/utilisateur.png" alt="mdo" width="32" height="32" class="rounded-circle" >
					</a>
					<ul class="dropdown-menu text-small end-0 ms-xl-5" style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translated(70px, 127.333px, 0px);" data-popper-placement="bottom-start">
						<li><a href="panier.php" class="dropdown-item">Panier</a></li>
                ...
                if (count($result) > 0) {
                    ...
                    if (count($result) > 0) {
                        ...
                        $user = $req->fetch();
                        $id = $user['id'];
                        echo '<li><a class="dropdown-item" href="add-oeuvres.php">Ajouter des oeuvres</a></li>
					<li><a class="dropdown-item" href="add-evenement.php">Ajouter des évènements</a></li>
					<li><a class="dropdown-item" href="add-blog.php">Ajouter des blogs</a></li>';   
                    } 
                }
				?>
			
					<li><hr class="dropdown-divider"></li>
					<li><a class="dropdown-item" href="déconnexion.php">Déconnexion</a></li>
					<li>
