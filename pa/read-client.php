...
<html>
	<head>
		...
		<title>Information d'utilisateur</title>
    ...
    <body>
		...
		<main>
		<div class="container">
        <h3 class="title-users" >Information d'utilisateur</h3>
		    <?php 
            ...
            if(isset($_GET['id'])){
                ...
                if($user){
                    echo '<p class="mb-2">Compte client';
                    echo '<p class="mb-2"><strong>Id :</strong> ' . $user['id'] . '</p>';
                    echo '<p class="mb-2"><strong>Pseudo :</strong> ' . $user['pseudo'] . '</p>';
                    echo '<p class="mb-2"><strong>Email :</strong> ' . $user['email'] . '</p>';
                    echo '<p class="mb-2"><strong>Nom :</strong> ' . $user['nom'] . '</p>';
                    echo '<p class="mb-2"><strong>Prénom :</strong> ' . $user['prenom'] . '</p>';
                } else {
